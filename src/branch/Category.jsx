...
function Category() {
  ...
  // Validate code (basic validation before backend check)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const checkResponse = await axios.get(`http://localhost:3001/check-code?code=${code}&branchManagerId=${branchManagerId}`);
        ...
        <form onSubmit={handleSubmit} className="space-y-4" noValidate>
          <div className="flex flex-wrap -mx-3 mb-6">
            ...
            <div className="w-full md:w-1/2 px-3 mb-4">
              ...
              <input
                ...
                required
                className={`w-full px-3 py-2 bg-gray-800 border ${errors.category ? 'border-red-500' : 'border-gray-600'} rounded-md text-white focus:outline-none focus:ring-2 focus:ring-blue-500`}
              />
            ...
            <div className="w-full md:w-1/2 px-3 mb-4">
              ...
              <input
                ...
                required
                className={`w-full px-3 py-2 bg-gray-800 border ${errors.code ? 'border-red-500' : 'border-gray-600'} rounded-md text-white focus:outline-none focus:ring-2 focus:ring-blue-500`}
              />
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              required
              className={`w-full px-3 py-2 bg-gray-800 border ${errors.description ? 'border-red-500' : 'border-gray-600'} rounded-md text-white focus:outline-none focus:ring-2 focus:ring-blue-500`}
            />
          ...
          <div className="flex justify-center">
            <button
              ...
              className={`w-full md:w-auto px-6 py-2 bg-blue-600 text-white font-semibold rounded-md shadow hover:bg-blue-500 transition duration-300 ${isSubmitting ? 'opacity-50 cursor-not-allowed' : ''}`}
            >
