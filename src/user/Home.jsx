...
function Home() {
  ...
  return (
    <div className="bg-gray-900 min-h-screen">
      ...
      <nav
        id="home"
        className="bg-gray-800 text-white py-4 px-8 fixed w-full z-50 shadow-md"
      >
...
<section className="relative bg-gray-900 text-white pt-32 pb-32 min-h-[80vh] flex items-center">
  <div className="absolute inset-0 overflow-hidden">
    <div className="absolute inset-0 bg-gray-900"></div> {/* Changed to solid gray-900 */}
  ...
  <div className="container mx-auto px-4 text-center relative z-10">
    <div className="max-w-4xl mx-auto">
      <h2
        ...
        className="text-5xl md:text-6xl font-bold mb-8 bg-gradient-to-r from-sky-400 to-indigo-400 bg-clip-text text-transparent"
      >
      ...
      >
        ...
        Gain real-time visibility and control over your business operations.
      </p>
      ...
      >
        {/* Decorative Blob SVG */}
        <div className="absolute -top-32 -left-32 w-96 h-96 bg-indigo-700 opacity-20 rounded-full mix-blend-multiply filter blur-3xl animate-pulse z-0" />
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4" data-aos="fade-right">
                ...
                <p className="text-gray-300 leading-relaxed text-lg">
                  We develop user-friendly inventory solutions tailored for
                  small to mid-sized businesses, focusing on reliability and
                  efficiency.
                </p>
              </div>
                ...
                <div className="bg-indigo-600 p-2 rounded-full">
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth={2}
                      d="M13 16h-1v-4h-1m4-4h.01M21 12.34A9.958 9.958 0 0012 2a9.958 9.958 0 00-9 5.34M3 12.34A9.958 9.958 0 0012 22a9.958 9.958 0 009-5.66"
                    />
                  </svg>
                </div>
                <p className="text-gray-300 leading-relaxed text-lg">
                  Our team focused on creating a scalable and secure solution
                  that balances usability with functionality, making stock
                ...
                <div className="bg-indigo-600 p-2 rounded-full">
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth={2}
                      d="M11 17a1 1 0 002 0v-6a1 1 0 00-2 0v6zM5 17a1 1 0 002 0V9a1 1 0 00-2 0v8zM17 17a1 1 0 002 0v-3a1 1 0 00-2 0v3z"
                    />
                  </svg>
                </div>
                <p className="text-gray-300 leading-relaxed text-lg">
                  Currently supporting multiple demo clients with real-time data
                  logging, role-based permissions, and streamlined stock
                  workflows.
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4" data-aos="fade-right">
                ...
                <p className="text-gray-300 leading-relaxed text-lg">
                  Our dashboard offers real-time inventory visibility,
                  actionable insights, and intuitive navigation — built to
                  reduce training time and operational friction.
                </p>
              </div>
              ...
              <div className="flex items-start space-x-4" data-aos="fade-left">
                ...
                <p className="text-gray-300 leading-relaxed text-lg">
                  Built with modern design principles to offer clarity, reduce
                  cognitive load, and support rapid decision-making.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {[
              ...
              },
              {
                ...
                icon: (
                  <path d="M9 17v-6h6v6m2 4H7a2 2 0 01-2-2V5a2 2 0 012-2h4l2 2h6a2 2 0 012 2v12a2 2 0 01-2 2z" />
                ),
              },
              {
                title: "Alerts",
                ...
                icon: (
                  <path d="M13 16h-1v-4h-1m4-4h.01M12 2a10 10 0 00-9.95 9.02A5.5 5.5 0 002 16.5V17h20v-.5a5.5 5.5 0 00-5.05-5.48A10 10 0 0012 2z" />
                ),
              },
              {
                ...
                icon: (
                  <path d="M17 9V7a4 4 0 00-8 0v2m1 4h6m-3 4v2m-8-2h1m12 0h1M5 13V9h14v4H5z" />
                ),
              },
              {
      ...
      <footer id="contact-us" className="bg-gray-800 text-white py-16 px-4">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 leading-relaxed">
              Powerful stock and inventory tools to help your business stay
          ...
          <div>
            ...
            <ul className="text-sm text-gray-300 space-y-2">
              ...
              <li className="flex items-center space-x-2">
                ...
                >
                  <path
                    d="M3 5h12M9 3v2m6 4v10m-3 3l3-3m0 0l3 3m-3-3v-4"
                    strokeWidth="2"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
        ...
        <div className="mt-12 border-t border-gray-700 pt-6 text-center text-sm text-gray-400">
          © {new Date().getFullYear()} Stock Management System. All rights
          reserved.
        </div>
      </footer>
    </div>
